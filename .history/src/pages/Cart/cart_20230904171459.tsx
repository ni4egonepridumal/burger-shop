                ...
                <div className={styles.container}>
                    <div className={styles.cart_inner}>
                        ...
                        <div className={styles.fixed}>
                            <DataUser setFlag={setFlag} totalPrice={totalPriceFromLocalStorage && totalPriceFromLocalStorage} />
                        </div>
                    </div>
                    ...
                    {flag && <h1 style={{ textAlign: "center", marginTop: "50px" }}>Ваш заказ оформлен  <br />ОБРАТИТЕ ВНИМАНИЕ, ЧТО ЭТО НЕНСТОЯЩИЙ ИНТЕРНЕТ МАГАЗИН, ВАШ ЗАКАЗ НЕ БУДЕТ СОБРАН ;)</h1>}
                </div>
                :
