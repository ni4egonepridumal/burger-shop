        ...
        <>
            {burgerFromLocalStorage.length > 0 ?
                <div className={styles.container}>
                    ...
                    {flag && <h1 style={{ textAlign: "center", marginTop: "50px" }}>Ваш заказ оформлен  <br />ОБРАТИТЕ ВНИМАНИЕ, ЧТО ЭТО НЕ НАСТОЯЩИЙ ИНТЕРНЕТ МАГАЗИН, ВАШ ЗАКАЗ НЕ БУДЕТ СОБРАН ;)</h1>}
                </div>
                :
