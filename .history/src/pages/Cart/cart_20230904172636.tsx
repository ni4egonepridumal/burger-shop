        ...
        <>
            {burgerFromLocalStorage.length > 0 ?
                <div className={styles.container}>
                    ...
                    {flag && <h1 style={{ textAlign: "center", marginTop: "50px" }}>Ваш заказ оформлен  <br /><span style={{ fontSize: '10px' }}>он в консоле</span><br />ОБРАТИТЕ ВНИМАНИЕ, ЧТО ЭТО НЕ НАСТОЯЩИЙ ИНТЕРНЕТ МАГАЗИН, ВАШ ЗАКАЗ НЕ БУДЕТ СОБРАН ;)</h1>}
                </div>
                :
