    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.burger_inner}>
                {isLoading ? <div className={styles.loader}><MoonLoaderfrom size={100} /></div> : burger === "alphabet" ? sortBurgerAlphabet?.map((burger: IBurger) => <BurgerCart key={burger.id} burgers={burger} />) : data?.map((burger: IBurger) => <BurgerCart key={burger.id} burgers={burger} />)}
            </div>
