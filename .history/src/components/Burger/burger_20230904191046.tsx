                    ...
                    <div>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className={styles.feedback_size}>
                            <Controller
                                control={control}
                                name="name"
                                rules={{ required: "Поле обязательное для заполнения", pattern: { value: /^[а-яА-ЯёЁa-zA-Z0-9]+$/, message: "Начните с буквы, вы ведь человек ??" } }}
                            ...
                            />
                            <span style={{ color: "red", fontSize: "18px" }}>{errors?.name && errors.name.message && "Начните с буквы, вы ведь человек ??"}</span>
                            <Controller
                                control={control}
                                name="comment"
                                rules={{ required: "Поле обязательное для заполнения", pattern: /^[а-яА-ЯёЁa-zA-Z0-9]+$/ }}
                                render={({ field: { onChange, onBlur } }) => (
                                    <InputFromRHF
                                        onMyChange={onChange}
                                        onMyBlur={onBlur}
                            ...
                            />
                            <span style={{ color: "red", fontSize: "18px" }}>{errors?.comment && "Начните с буквы, вы ведь человек ??"}</span>
