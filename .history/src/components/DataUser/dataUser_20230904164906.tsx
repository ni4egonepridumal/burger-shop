...
export const DataUser = () => {
    ...
    const filterBurgerOnCart = burgerToCart.map((item: IBurger) => ({ "name": item.name, "count": item.count }));
    const addDataFromOrderJSON = (dataFromForm: IInputForm, filterBurgerOnCart: any) => {
        setOrderJSON({
