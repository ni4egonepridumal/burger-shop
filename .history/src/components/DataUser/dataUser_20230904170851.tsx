...
export const DataUser: React.FC<IPropsDataUser> = ({ totalPrice }) => {
    ...
    return (
        <div>
            ...
            {flag && <h1>Ваш заказ оформлен  <br />ОБРАТИТЕ ВНИМАНИЕ, ЧТО ЭТО НЕНСТОЯЩИЙ ИНТЕРНЕТ МАГАЗИН, ВАШ ЗАКАЗ НЕ БУДЕТ СОБРАН ;)</h1>}
        </div>
    );
};
