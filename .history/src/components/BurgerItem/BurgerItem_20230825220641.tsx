...
export const BurgerItem: React.FC<IBurgerCartProps> = ({ burgers }) => {
    ...
    const currentBurger = burgetToCart.some(burger => burger.id === burgers.id)
    return (
        <div className={styles.burger_cart}>
            ...
            <div className={styles.burger_footer}>
                ...
                <Button viev='primary' size='s' onClick={addBurgerFromCart}>{currentBurger ? "В корзину" : "Удалить"}</Button>
            </div>
