...
import { setPlusCount } from '../../redux/slices/countBurgerSlice';
...
export const OneBurgerFromCart = ({ burger, totalPrice, setTotalPrice }: IOneBurgerFromCart) => {
    ...
    const { burgerCount } = useAppSelector(state => state)
    ...
    const handlePlusClick = () => {
        ...
        dispatch(setPlusCount(burger.id))
    }
    ...
    return (
        <div className={styles.position}>
            ...
            <div>
                ...
                <div style={{ textAlign: "center" }}><span className={styles.button} onClick={handleMinusClick}>-</span>{burger.count}<span className={styles.button} onClick={handlePlusClick}>+</span></div>
            </div>
            <div>
