    ...
    return (
        <div className={styles.position}>
            ...
            <div>
                ...
                <div style={{ textAlign: "center" }}><span className={styles.button}>-</span>{burgerItem}<span className={styles.button} onClick={() => setBurgerPrice(burgerPrice + burger.price)}>+</span></div>
            </div>
            <div>
