    ...
    return (
        <div className={styles.position}>
            ...
            <div>
                ...
                <div style={{ textAlign: "center" }}><span className={styles.button} onClick={handleMinusClick}>-</span>{totalPrice}<span className={styles.button} onClick={handlePlusClick}>+</span></div>
            </div>
            <div>
